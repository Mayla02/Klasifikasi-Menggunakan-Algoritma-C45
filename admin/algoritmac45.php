...
<body>
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <ul class="breadcrumb">
                <li><a href="#">Home</a></li>                    
                <li class="active">Algoritma c45</li>
            </ul>
            
            <div class="page-title">                    
                <h2><span class="fa fa-arrow-circle-o-left"></span>Data Hasil Algoritma C45</h2>
            </div>                 
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">                                
                                <h3 class="panel-title">Pohon Keputusan Algoritma C45</h3><br>
                            ...
                            <a href="ibuhamil-add.php"><button class="btn btn-info"><i class="fa fa-plus"></i>Tambah Data</button> </a>
                            ...
                            <div class="panel-body">
                                 <table id="example" class="display nowrap" style="width:100%">
                                    ...
                                    $sql = "SELECT * FROM ibuhamil INNER JOIN posyandu ON ibuhamil.id_posyandu = posyandu.id_posyandu";
                                        ...
                                        while($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo "
                                                <tr> 
                                                    ...
                                                    <td>$penanganan</td> 
                                                    <td>
                                                        <a href='ibuhamil-edit.php?id_ih=$row[id_ih]' id_ih='$row[id_ih]'><button class='btn btn-default'><i class='fa fa-pencil'></i></button></a>
                                                        <a href='ibuhamil-delete.php?id_ih=$row[id_ih]'><button class='btn btn-warning'><i class='fa fa-trash-o'></i></button></a>
                                                    </td>                                    
                                                </tr>
                                            "; 
                                        }
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="metrics">
                                    ...
                                    <p><strong>Akurasi:</strong> <?php echo number_format($akurasi * 50, 2) . "%"; ?></p>
                                    <p><strong>Presisi:</strong> <?php echo number_format($presisi * 250, 2) . "%"; ?></p>
                                    <p><strong>Recall:</strong> <?php echo number_format($recall * 100, 2) . "%"; ?></p>
                                    <p><strong>F1 Score:</strong> <?php echo number_format($f1Score * 50, 2); ?></p>
                                </div>
                            </div>
                        </div>

...
echo "
                 ...
                 ";
                echo ' 
                <h2 class="tgh" id="nama">Laporan Data Pemeriksaan Akhir<br></h2> 
            ...
            <div class="">
                <table class="demo-table" width="100%" cellspacing="0" >
                    ...
                    <tbody>
                                ...
                                ';
include "../koneksi.php";
                            $querydosen = mysqli_query ($konek, "SELECT * FROM pemeriksaan_akhir 
                        ...
                        $no = 0;
                                while($dosen = mysqli_fetch_array($querydosen)){
                                 ...
                                 <tr>
                                        <td>'.$no.'</td>
                                        <td>'.$dosen['id_pemeriksaan_akhir'].'</td>
                                        <td>'.$dosen['nama_ih'].'</td>
                                        <td>'.$dosen['usia_pemeriksaan_akhir'].'</td>
                                        <td>'.$dosen['ukur_lila_pemeriksaan_akhir'].'</td> 
                                        <td>'.$dosen['bb_pemeriksaan_akhir'].'</td>
                                        <td>'.$dosen['tb_pemeriksaan_akhir'].'</td>
                                        <td>'.$dosen['imt_pemeriksaan_akhir'].'</td>
                                        <td>'.$dosen['nama_posyandu'].'</td> 
                                        <td>'.$dosen['alamat'].'</td> 
                                        <td>'.$dosen['tgl_pemeriksaan_akhir'].'</td> 
                                        <td>'.$dosen['status_pemeriksaan_akhir'].'</td> 
                                        <td>'.$dosen['penanganan_pemeriksaan_akhir'].'</td>  
                                </tr>
                            ';
                                }
                            echo '

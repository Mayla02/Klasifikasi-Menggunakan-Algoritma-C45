...
JL. Poros Kebupaten Nomor 01 RT. 02 RW. 01 Desa Handiwung</span>
</div>
...
echo "
                 ...
                 ";
                echo ' 
                <h5 class="tgh" id="nama">Laporan Data Ibu Hamil Posyandu Desa Handiwung<br></h5> 
...
if(isset($_REQUEST['submit'])){
            ...
            $id_posyandu = $_REQUEST['id_posyandu'];

            if($_REQUEST['id_posyandu'] == ""){
                header("Location: ./admin.php?page=asm");
                die();
            } else {
$sql = "SELECT * FROM ibuhamil 
        INNER JOIN posyandu ON posyandu.id_posyandu = ibuhamil.id_posyandu
        WHERE posyandu.id_posyandu = '$_REQUEST[id_posyandu]'";
...
if (mysqli_num_rows($result) > 0) {
    ...
    // Hitung rata-rata IMT
    $average_imt = $total_imt / $count_imt;
} else {

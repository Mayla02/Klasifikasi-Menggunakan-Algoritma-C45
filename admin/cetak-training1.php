...
echo "
                 ...
                 ";
                echo ' 
                <h5 class="tgh" id="nama">Laporan Data Training<br></h5> 
            ...
            <div class="">
                <table class="demo-table" width="100%" cellspacing="0" >
                    ...
                    <tbody>
                                ...
                                ';
include "../koneksi.php";
                            $querydosen = mysqli_query ($konek, "SELECT * FROM training INNER JOIN posyandu ON training.id_posyandu = posyandu.id_posyandu");
                        if($querydosen == false){
                            die ("Terjadi Kesalahan : ". mysqli_error($konek));
                                ...
                                while($dosen = mysqli_fetch_array($querydosen)){
                                 ...
                                 <tr>
                                        <td>'.$no.'</td>
                                        <td>'.$dosen['id_training'].'</td>
                                        <td>'.$dosen['nama_training'].'</td>
                                        <td>'.$dosen['usia_training'].'</td>
                                        <td>'.$dosen['ukur_lila'].'</td> 
                                        <td>'.$dosen['bb'].'</td>
                                        <td>'.$dosen['tb'].'</td>
                                        <td>'.$dosen['id_posyandu'].'</td>
                                        <td>'.$dosen['alamat'].'</td> 
                                        <td>'.$dosen['tgl'].'</td> 
                                        <td>'.$klasifikasi.'</td>
                                </tr>

...
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    ...
    <body>
     ...
     <title>Tentang Klasifikasi Ibu Hamil</title>
    <style>
        body { 
        }
        .container {
...
<div class="container">
    <h1>Tentang Klasifikasi Ibu Hamil</h1>
    <img src="ibuhamil.jpg" alt="Ibu Hamil" />
    <p>
        Klasifikasi Ibu Hamil adalah sebuah website yang bertujuan untuk membantu memantau dan mengklasifikasikan kondisi kesehatan ibu hamil. <br>website ini menyediakan informasi yang diperlukan untuk membantu ibu hamil dan petugas medis dalam mengidentifikasi risiko kesehatan serta <br>memberikan langkah-langkah yang tepat untuk menjaga kesehatan ibu dan janin.
    </p>
    <p>
        
        <ul style="text-align: left;">
            <li>Melakukan klasifikasi terhadap kondisi kesehatan ibu hamil berdasarkan data dan informasi yang diberikan.</li>
            <li>Memberikan langkah-langkah penanganan yang tepat berdasarkan hasil klasifikasi untuk menjaga kesehatan ibu dan janin.</li>

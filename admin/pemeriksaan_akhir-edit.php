...
$querymatakuliah = mysqli_query($konek, "SELECT * FROM pemeriksaan_akhir INNER JOIN ibuhamil ON ibuhamil.id_ih = pemeriksaan_akhir.id_ih
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" method="POST" action="pemeriksaan_akhir_proses_edit.php" enctype="multipart/form-data">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Edit</strong> Pemeriksaan Akhir</h3>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" readonly name="id_pemeriksaan_akhir" class="form-control"
                                                        value="<?php echo $matakuliah["id_pemeriksaan_akhir"]; ?>"/>
                                                    </div>                                             
                                                </div>
                                            </div> 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                                                                            
                                                    <select class="form-control select" name="id_ih" id="id_ih">
                                                        ...
                                                        <?php echo $matakuliah["nama_ih"]; ?></option>
                                                        <?php
include "../koneksi.php"; 
                                            ...
                                            <div class="form-group">                                        
                                                ...
                                                <div class="col-md-9 col-xs-12">
                                                    <div class="input-group">
                                                        ...
                                                        value="<?php echo $matakuliah["usia_pemeriksaan_akhir"]; ?>"/>
                                                    </div>             
                                                </div>
                                            </div> 
                                            ...
                                            <div class="form-group">                                        
                                                ...
                                                <div class="col-md-9 col-xs-12">
                                                    <div class="input-group">
                                                        ...
                                                        value="<?php echo $matakuliah["ukur_lila_pemeriksaan_akhir"]; ?>"/>
                                                    </div>             
                                                </div>
                                            </div> 
                                            ...
                                            <div class="form-group">                                        
                                                ...
                                                <div class="col-md-9 col-xs-12">
                                                    <div class="input-group">
                                                        ...
                                                        value="<?php echo $matakuliah["bb_pemeriksaan_akhir"]; ?>"/>
                                                    </div>             
                                                </div>
                                            </div> 
                                            ...
                                            <div class="form-group">                                        
                                                ...
                                                <div class="col-md-9 col-xs-12">
                                                    <div class="input-group">
                                                        ...
                                                        value="<?php echo $matakuliah["tb_pemeriksaan_akhir"]; ?>"/>
                                                    </div>             
                                                </div>
                                            </div> 
                                            ...
                                            <div class="form-group">                                        
                                                ...
                                                <div class="col-md-9 col-xs-12">
                                                    <div class="input-group">
                                                        ...
                                                        value="<?php echo $matakuliah["imt_pemeriksaan_akhir"]; ?>"/>
                                                    </div>             
                                                </div>
                                            </div> 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                                                                            
                                                    <select class="form-control select" name="id_posyandu" id="id_posyandu">
                                                        ...
                                                        <?php echo $matakuliah["nama_posyandu"]; ?></option>
                                                        <?php
include "../koneksi.php"; 
//display values in combobox/dropdown
                                            ...
                                            <div class="form-group">                                        
                                                ...
                                                <div class="col-md-9 col-xs-12">
                                                    <div class="input-group">
                                                        ...
                                                        value="<?php echo $matakuliah["tgl_pemeriksaan_akhir"]; ?>"/>
                                                    </div>             
                                                </div>
                                            </div> 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                                                                            
                                                    <select class="form-control select" name="status_pemeriksaan_akhir" id="status_pemeriksaan_akhir">
                                                        <option value="<?php echo $matakuliah["status_pemeriksaan_akhir"]; ?>">
                                                        <?php echo $matakuliah["status_pemeriksaan_akhir"]; ?></option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                                                                            
                                                    <select class="form-control select" name="penanganan_pemeriksaan_akhir" id="penanganan_pemeriksaan_akhir">
                                                        <option value="<?php echo $matakuliah["penanganan_pemeriksaan_akhir"]; ?>">
                                                        <?php echo $matakuliah["penanganan_pemeriksaan_akhir"]; ?></option>

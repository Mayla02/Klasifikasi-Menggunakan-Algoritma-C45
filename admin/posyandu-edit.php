...
$querymatakuliah = mysqli_query($konek, "SELECT * FROM posyandu WHERE id_posyandu='$id_posyandu'");
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" method="POST" action="posyandu_proses_edit.php" enctype="multipart/form-data">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Edit</strong> Posyandu</h3>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="id_posyandu" readonly class="form-control"
                                                        value="<?php echo $matakuliah["id_posyandu"]; ?>"/>
                                                    </div>                                             
                                                </div>
                                            </div>   

                                            <div class="form-group">                                        
                                                <label class="col-md-3 control-label">nama_posyandu</label>
                                                <div class="col-md-9 col-xs-12">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="text" name="nama_posyandu" class="form-control"
                                                        value="<?php echo $matakuliah["nama_posyandu"]; ?>"/>
                                                    </div>             
                                                </div>
                                            </div> 

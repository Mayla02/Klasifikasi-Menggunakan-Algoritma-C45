                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" method="POST" action="hasilakhir-aksi.php" enctype="multipart/form-data">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Tambah</strong> Hasil Akhir</h3>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                                                                            
                                                    <select class="form-control select" name="id_ih" id="id_ih">
                                                        <option hidden>Pilih Ibu Hamil</option>
                                                        <?php
                                                            include "../koneksi.php"; 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                                                                            
                                                    <select class="form-control select" name="id_pmt" id="id_pmt">
                                                        <option hidden>Pilih PMT</option>
                                                        <?php
include "../koneksi.php"; 
//display values in combobox/dropdown
...
?>
                                ...
                                <script>
        document.getElementById("id_ih").addEventListener("change", function() {
            var id_ih = this.value;
            var xhr = new XMLHttpRequest();
            xhr.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    var data = JSON.parse(this.responseText);
                    document.getElementById("ukur_lila").value = data.ukur_lila;
                }
            };

             // URL permintaan ke skrip PHP pada halaman yang sama
        var url = "hasilakhir-add.php?id_ih=" + id_ih;
